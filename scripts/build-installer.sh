...
2. 설치가 완료되면 설치 파일을 유지하거나 휴지통으로 옮겨 주세요.
3. 설치 창을 닫고 Finder에서 이 디스크를 추출하세요.
4. 메뉴 막대의 Jaso NFC에서 ‘정리할 폴더…’를 선택하세요.
...
2. After installation, choose Keep Installer or Move Installer to Trash.
3. Close the installer and eject this disk in Finder.
4. In the Jaso NFC menu, choose Manage folders….
